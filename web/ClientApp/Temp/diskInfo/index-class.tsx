...
class DiskInfoClass extends React.Component<IProps, {}> {
    state = {
        status: "empty"
    }
    ...
    button_Click()
    {
        ...
        this.props.setDiskInfo(diskInfo);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DiskInfoClass);
